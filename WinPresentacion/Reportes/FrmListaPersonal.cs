...
namespace WinPresentacion.Reportes
{
    public partial class FrmListaPersonal : Form
    {
        ...
        public void anchogrid()
        {
            ...
            this.dataListado.Columns[8].Width = 380;

        }

        private void CargarDatos()
        {
            dataListado.DataSource = CtrlPersonal.ListarTodos();
        ...
        {
            dataListado.DataSource = CtrlPersonal.ListarPersonalApPaterno(txtApPaterno.Text);
            this.dataListado.Columns.Cast<DataGridViewColumn>().ToList().ForEach(c => c.HeaderText = c.HeaderText.ToUpper());
            anchogrid();
            OcultarColumnas();
            lblCantidad.Text = "Total de Registros " + dataListado.Rows.Count;
        ...
        {
            dataListado.DataSource = CtrlPersonal.ListarPersonalDNI(txtDNI.Text);
        ...
        private void FrmListaPersonal_Load(object sender, EventArgs e)
        {
            this.Top = 40;
            this.Left = 40;
            CargarDatos();
        ...
        private void FrmListaPersonal_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void dataListado_Click(object sender, EventArgs e)
        {
            ...
            lblCargo.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["cargo"].Value);
        }
        ...
        {
            FrmReportePersonal re = new FrmReportePersonal();
            re.ShowDialog();
        }
