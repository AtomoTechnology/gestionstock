...
{
    public partial class FrmVentasLst : Form
    {
        ...
        {
            this.gvVenta.DataSource = CtrlVenta.Mostrar(IdAlmacen);
        ...
        private void FrmVentasLst_Load(object sender, EventArgs e)
        {
            this.Left = 40;
            this.Top = 40;
        ...
        private void FrmVentasLst_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
