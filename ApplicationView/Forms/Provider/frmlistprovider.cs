...
namespace ApplicationView.Forms.Provider
{
    public partial class frmlistprovider : Form
    {
        ...
        {
            this.dataList.DataSource = RepoPathern.ProviderService.GetAll(1, LoginInfo.pageactual, LoginInfo.pagesize, "Id", "asc", "", ref count);
            this.HideColumn();
            this.GetPagination();
        }
        ...
        private void SearchByName()
        {
            ...
            {
                this.dataList.DataSource = RepoPathern.ProviderService.GetAll(1, LoginInfo.pageactual, LoginInfo.pagesize, "Id", "asc", this.txtsearch.Text.Trim(), ref count);
                this.GetPagination();
            }
            else
                this.LoadList();
        ...
        private void frmlistprovider_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void frmlistprovider_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmlistprovider_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmlistprovider_Validated(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmlistprovider_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        }
