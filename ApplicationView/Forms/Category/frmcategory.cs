    ...
    public partial class frmcategory : Form
    {
                    ...
                    if (Opcion == DialogResult.OK)
                    {
                        ...
                        foreach (DataGridViewRow row in dataList.Rows)
                        {
                            if (Convert.ToBoolean(row.Cells[0].Value))
                            {
                                ...
                                resp = RepoPathern.CategoryService.Delete(Codigo);
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    RJMessageBox.Show("Debe ingresar  el nombre de la categoria", "Sistema de ventas", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                else
                {
                    ...
                    if (Isnuevo)
                        resp = RepoPathern.CategoryService.Create(be);
                    else
                        resp = RepoPathern.CategoryService.Update(txtcode.Text.Trim(), be).ToString();
        ...
        private void frmcategory_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmcategory_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmcategory_Validated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
