...
namespace ApplicationView.Forms.Product
{
    public partial class frmupdatestock : Form
    {
        ...
        private void dataList_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            frmsingleupdatestock frm = new frmsingleupdatestock((ProductBE)selectedRow.DataBoundItem);
            frm.ShowDialog();
            this.LoadList();
        }
        ...
        private void frmupdatestock_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void frmupdatestock_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmupdatestock_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmupdatestock_Validated(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmupdatestock_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        }
