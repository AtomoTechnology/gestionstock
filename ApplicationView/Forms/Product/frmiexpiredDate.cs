...
{
    public partial class frmiexpiredDate : Form
    {
        int count = 0;
        ...
        public frmiexpiredDate()
        {
            InitializeComponent();
            DataListHelper.SetGrid(this.dataList, 14);
            this.dtTPfrom.Value = DateTime.Now.AddDays(-1);
        ...
        {
            this.dataList.DataSource = RepoPathern.ProductService.GetAllExpiredProduct(1, LoginInfo.pageactual, LoginInfo.pagesize, "Id", "asc", this.dtTPfrom.Value, this.dtTPto.Value, ref count);
            this.HideColumn();
            this.GetPagination();
        }
        ...
        {
            if (this.dtTPfrom.Value >= this.dtTPto.Value)
            {
                RJMessageBox.Show("La fecha desde no puede ser mayor o igual a la fecha hasta", "Sistema de ventas", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else
            {
        ...
        private void frmiexpiredDate_Load(object sender, EventArgs e)
        {
            this.LoadList();
        }
        ...
        private void frmiexpiredDate_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void frmiexpiredDate_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmiexpiredDate_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void frmiexpiredDate_Validated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
        ...
        private void frmiexpiredDate_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        }
